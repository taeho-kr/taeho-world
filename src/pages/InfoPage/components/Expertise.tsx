...
const expertises: Expertise[] = [
  {
    ...
    description: <Text size="subtitle">User interface builder.</Text>,
  },
  {
    area: 2,
    icon: <CodeXml />,
    ...
    description:
      "Always develop software with scalability and maintainability in mind.",
  },
  {
    area: 3,
    icon: <Sparkles />,
  ...
  },
  {
    ...
    description:
      "Always try to develop a good UX until the end. I think a beautiful UX always has the best value.",
  },
];
    ...
    <div className="w-full h-full flex flex-col items-center justify-center">
      ...
      >
        {expertises.map((expertise) => (
          <div
            key={expertise.title}
            className="flex flex-col items-center gap-2 p-6 border"
            style={{
          ...
          >
            <div className="flex flex-row gap-6 items-center ">
              {typeof expertise.icon === "string" ? (
                <img className="w-10 h-10" src={expertise.icon} />
              ) : (
            ...
            <Text
              size="body"
              weight="regular"
              className="break-word max-w-[280px]"
            >
